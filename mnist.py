import csv
import numpy as np
from np import Layer, Network, LeakyRelu, MSE
...
if __name__ == "__main__":
    ...
    # Test the network.
    test_data = load_data("/Users/daniel/Downloads/mnistdata/mnist_test.csv")
    accuracy = test(net, test_data)
    print(f"Accuracy: {round(100 * accuracy, 2)}%")

    # Train the network.
    train_data = load_data("/Users/daniel/Downloads/mnistdata/mnist_train.csv")
